...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "task",
        loadChildren:
          "./theme/task/task.module#TaskModule"
      },
      {
        path: "config",
        loadChildren:
      ...
      },
      {
        path: "application",
        loadChildren:
          "./theme/application/application.module#ApplicationModule"
      },
      {
        path: "employees",
        loadChildren:
          "./theme/employees/employees.module#EmployeesModule"
      },
      {
        path: "attendance",
        loadChildren:
          "./theme/attendance/attendance.module#AttendanceModule"
      },
      {
        path: "profile",
        loadChildren:
          "./theme/profile/profile.module#ProfileModule"
      },
      {
        path: "payroll",
        loadChildren:
          "./theme/payroll/payroll.module#PayrollModule"
      },
      {
        path: "reports",
        loadChildren:
          "./theme/reports/reports.module#ReportsModule"
      }
    ]
  },
  {
